...
export default function SectionSixSeven() {
                  ...
                  {["Fill", "N/A"].map((title) => (
                    <div className="flex items-center gap-x-2" key={title}>
                      <Field
                        ...
                        value={title}
                        id={title}
                        checked={values.iPFill === title}
                        onChange={() => {
                          setFieldValue("iPFill", title);
                          setIsIP(title);
                        }}
                      />
                      <label
